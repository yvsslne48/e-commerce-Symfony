    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $categoriesData = [
            [
                ...
                'badgeColor'  => 'primary',
                'products'    => [
                    ['name' => 'Wireless Headphones',   'price' => '79.99', 'image' => 'wireless-headphones.png', 'sku' => 'WH-001',  'description' => 'Experience premium sound quality with our wireless headphones. Featuring advanced noise cancellation technology, comfortable over-ear design, and up to 30 hours of battery life.'],
                    ['name' => 'Bluetooth Speaker',     'price' => '59.99',  'sku' => 'BS-001',  'description' => 'Portable Bluetooth speaker with 360° sound and waterproof design. Perfect for outdoor adventures and home use.'],
                    ['name' => 'Smartphone Stand',      'price' => '19.99',  'sku' => 'SS-001',  'description' => 'Adjustable aluminum smartphone stand compatible with all devices. Foldable and portable.'],
                    ['name' => 'USB-C Cable 2m',        'price' => '12.99',  'sku' => 'UC-001',  'description' => 'Durable braided USB-C cable with fast charging support up to 100W and data transfer at 10Gbps.'],
                    ['name' => 'Wireless Mouse',        'price' => '29.99',  'sku' => 'WM-001',  'description' => 'Ergonomic wireless mouse with silent click technology. Up to 18 months battery life.'],
                    ['name' => 'Mechanical Keyboard',   'price' => '89.99',  'sku' => 'MK-001',  'description' => 'Compact mechanical keyboard with RGB backlight and tactile switches. Ideal for gaming and coding.'],
                    ['name' => 'Webcam HD 1080p',       'price' => '49.99',  'sku' => 'WC-001',  'description' => 'Full HD webcam with built-in microphone and auto light correction for professional video calls.'],
                    ['name' => 'Power Bank 20000mAh',   'price' => '39.99',  'sku' => 'PB-001',  'description' => 'High capacity power bank with 3 USB outputs and LED charge indicator. Charges up to 5 devices simultaneously.'],
                    ['name' => 'Smart Watch Pro',       'price' => '199.99', 'sku' => 'SW-001',  'description' => 'Smartwatch with heart rate monitor, GPS, sleep tracking and 7-day battery life. Water resistant up to 50m.'],
                    ['name' => 'Noise Cancelling Earbuds', 'price' => '69.99', 'sku' => 'NE-001', 'description' => 'True wireless earbuds with active noise cancellation and 24h total battery life with the charging case.'],
                    ['name' => 'HDMI Cable 4K',         'price' => '15.99',  'sku' => 'HC-001',  'description' => 'Ultra-high-speed HDMI cable supporting 4K@120Hz and 8K@60Hz. Ideal for gaming consoles and monitors.'],
                    ['name' => 'Laptop Stand',          'price' => '34.99',  'sku' => 'LS-001',  'description' => 'Adjustable aluminum laptop stand with 6 height levels. Compatible with all laptops from 10 to 17 inches.'],
                ],
            ],
            [
                'name'        => 'Fashion',
